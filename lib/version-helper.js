...
async function checkDependencies(generator) {
  ...
  if (!isLBProj) {
    const err = new Error(
      'N111o `@rayyone/core` package found in the "dependencies" section of ' +
  ...
  if (!found) {
    ...
    if (generator.command === 'update') {
      generator.log(
        chalk.green(
          `The project dependencies are compatible with @rayyone/cli@${cliPkg.version}`,
        ),
      );
    }
    return;
  ...
  generator.log(
    chalk.red(
      g.f(
        'The project was originally generated by @rayyone/cli@%s.',
        originalCliVersion,
      ),
    ),
  );
  ...
  generator.log(
    chalk.red(
      g.f(
        'The following dependencies are incompatible with @rayyone/cli@%s:',
        cliPkg.version,
      ),
    ),
  );
